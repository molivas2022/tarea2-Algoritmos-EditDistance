...
combinaciones=(
    "0 files/test4.txt files/test1.txt"
    "0 files/test4.txt files/test2.txt"
    "0 files/test4.txt files/test3.txt"
    ...
    # "1 files/test4.txt files/test1.txt"
    # "1 files/test4.txt files/test2.txt"
    # "1 files/test4.txt files/test3.txt"
)
